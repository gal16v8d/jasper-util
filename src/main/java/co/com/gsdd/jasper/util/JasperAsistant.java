...
public class JasperAsistant {
    ...
    public byte[] createXlsReportBytes(JasperObject objectJ) {
        ...
        try {
            ...
            this.jasperReport = JasperCompileManager.compileReport(report);
            this.dataSource = new JRBeanCollectionDataSource(objectJ.getDataList());
            JasperPrint jasperPrint = JasperFillManager.fillReport(this.jasperReport, objectJ.getParameters(),
                    this.dataSource);
     ...
     * 
     * @param objectJ
     * @throws ReportFilePathException
     *             if report file path is not defined.
     * @throws OutFilePathException
     *             if output file path is not defined.
     */
